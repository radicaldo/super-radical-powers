...
- **super-radical-powers:requesting-code-review** - Code review template for reviewer subagents
- **super-radical-powers:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **super-radical-powers:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **super-radical-powers:executing-plans** - Use for parallel session instead of same-session execution
